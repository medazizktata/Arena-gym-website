    ...
    <div className="flex justify-center items-center min-h-screen">
      <div className="outer-box flex overflow-hidden max-w-4xl mx-auto">
        <div className="trap-left w-1/2">
          ...
          <h1 className="text-3xl font-bold mb-4">{text_grand}</h1> {/* Ajustez ces classes selon la taille souhaitée */}
          <p>{text}</p> {/* Ajoutez les classes pour le texte ici si nécessaire */}
        </div>
