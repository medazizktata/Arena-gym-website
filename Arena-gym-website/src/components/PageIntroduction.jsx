      ...
      <div className="my-20 relative">
        <div className="inline-block flex flex-col relative z-10">
          <div className="transform translate-y-28">
            <div
              className={`w-[80%] mx-auto transform translate-y-${translateValue} opacity-80`}
            >
              <BackgroundText
                text={`${BGText}`}
                strokeColor="white"
          ...
          <h1
            className={`inline font-Gentona font-black text-9xl inline ${titleProps}`}
          >
            {title}
          </h1>
          <h2 className={`inline ${subTitleProps}`}>{subTitle}</h2>
        </div>
